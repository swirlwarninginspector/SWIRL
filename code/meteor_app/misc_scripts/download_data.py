...
urls = []
with open('/Users/hongjinkang/repos/codeql_results/codeql_analysis/codeql_latest_analysis/apache-hbase.md') as infile:
    for line in infile:
        if line.startswith('['):
...
if not os.path.exists('/Users/hongjinkang/repos/suppression_interface/GithubExamples/crypto'):
    os.makedirs('/Users/hongjinkang/repos/suppression_interface/GithubExamples/crypto')
...
for url in urls:
    ...
    with open('/Users/hongjinkang/repos/suppression_interface/GithubExamples/crypto/' + url.split('/')[-1], 'w') as outfile:
