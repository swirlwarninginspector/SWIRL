...
if not os.path.exists('/Users/hongjinkang/repos/suppression_interface/GithubExamples/strings'):
    os.makedirs('/Users/hongjinkang/repos/suppression_interface/GithubExamples/strings')
...
for url in urls:
    ...
    with open('/Users/hongjinkang/repos/suppression_interface/GithubExamples/strings/' + url.split('/')[-1], 'w') as outfile:
